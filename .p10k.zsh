# Generated by Powerlevel10k configuration wizard on 2022-02-13 at 01:23 HST.
...
() {
  ...
  function my_git_formatter() {
    ...
    # HACK to add NIX to git prompt -- should go elsewhere!  for nix-develop, not supported in this version of p10k
